...
namespace Chapter9
{
    ...
    public class Chapter9
    {
        ...
        [MenuItem("Raytracing/Chapter9/1")]
        public static void Main()
        {
            ...
            list.Add(new Sphere(new Vector3(-1, 0, -1), 0.5f, new Dielectric(1.5f)));
            ...
            ImageHelper.SaveImg(tex, "Img/chapter9_1my.png");
            Debug.Log("Chapter 9_1 done");
        }


        [MenuItem("Raytracing/Chapter9/2")]
        public static void Main2()
        {
            ...
            ImageHelper.SaveImg(tex, "Img/chapter9_2.png");
            Debug.Log("Chapter 9_2 done");
        }
